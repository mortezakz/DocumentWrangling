...
public class TestClass {
	...
	public static void main(String[] args) throws IOException {
		...
		nextLine = reader.readNext(); //skips first row, which contains only headings
		...
		while ((nextLine = reader.readNext()) != null) {
			...
			// checks for and deletes institution (lower case)
			...
			// checks for and deletes institution (upper case)
